(function ($) {
  ...
  $.fn.panel = function (userConfig) {
    ...
    // Event: Touch stuff (using passive listeners for better performance).
    ...
    $this[0].addEventListener(
      ...
      function (event) {
        ...
        var diffX = $this.touchPosX - event.touches[0].pageX,
          diffY = $this.touchPosY - event.touches[0].pageY,
          th = $this.outerHeight(),
      ...
      { passive: false }
    ); // Can't be passive due to preventDefault
